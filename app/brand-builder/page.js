...
export default function BrandPage(){return <SiteShell>
  <PageHero eyebrow="品牌建立" title={<>品牌不是包裝出來的。<br/>是被理解與相信出來的。</>} description="先讓產品有清楚的理由、原料與使用價值，再把命名、包裝、故事與商品頁整理成一致的品牌體驗。" scene="brand" imageAlt="CRU LAB 高質感瓶身、外盒、粉包與品牌識別組合" actionHref="#builder" actionLabel="開始建立品牌方向" tone="cream"/>
