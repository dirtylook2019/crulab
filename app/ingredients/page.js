...
export default function IngredientsPage(){return <SiteShell>
  <PageHero eyebrow="原料資料庫" title={<>每一種原料，<br/>都應該被真正理解。</>} description="不只看熱門名稱，也理解來源、有效規格、研究條件、建議劑量與應用限制。選擇原料，是產品設計中最重要的決策之一。" image={media.orange} imageAlt="西西里血橙與原料研究" imagePosition="center 48%" actionHref="#database" actionLabel="開始探索原料" tone="cream"/>
