...
export default function IngredientsPage(){return <SiteShell>
  ...
  <section className="ingredientEvidence"><figure><LuxuryMedia scene="research" alt="暖白研究實驗室、顯微鏡、文獻與原料驗證場景"/></figure><div><span className="eyebrow">研究證據的層次</span><h2>研究數量不是全部。<br/>研究品質才是。</h2><p>我們會一起看研究設計、樣本條件、原料規格、使用劑量、研究時間、統計結果與限制，不把相關性寫成保證，也不把單一研究放大成神話。</p></div></section>
</SiteShell>}
