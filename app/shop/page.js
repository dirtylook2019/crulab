...
export default function ShopPage(){return <SiteShell>
  <PageHero eyebrow="品牌商城" title={<>每一款產品，<br/>都有一個被創造的理由。</>} description="CRU SHOP 展示從真實需求、研究與原料開始的產品。不是更多選擇，而是讓每一個選擇都更清楚。" image={media.whiteBottle} imageAlt="CRU LAB 精品健康產品陳列" actionHref="#products" actionLabel="探索產品"/>
