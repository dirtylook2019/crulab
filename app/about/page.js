...
export default function AboutPage(){return <SiteShell>
  <PageHero eyebrow="CRU LAB 為何誕生" title={<>不是先想著<br/>要賣什麼。</>} description="而是先問：我真正遇到的問題是什麼？CRU LAB 從個人需求、研究與配方開始，讓一款產品先對創造它的人有價值。" scene="research" imageAlt="CRU LAB 高質感研究實驗室與品牌起點" actionLabel="從自己的需求開始"/>
