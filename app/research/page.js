...
export default function ResearchPage(){return <SiteShell>
  <PageHero eyebrow="研究中心" title={<>證據先於承諾。<br/>理解先於選擇。</>} description="我們不替原料製造神話，而是把研究目的、方法、結果、原料規格與限制整理成品牌與使用者都能理解的內容。" image={media.researchDesk} imageAlt="研究文獻、筆記與營養科學資料" actionHref="#journal" actionLabel="進入研究筆記"/>
