...
export default function ResearchPage(){return <SiteShell>
  <PageHero eyebrow="研究中心" title={<>證據先於承諾。<br/>理解先於選擇。</>} description="我們不替原料製造神話，而是把研究目的、方法、結果、原料規格與限制整理成品牌與使用者都能理解的內容。" scene="research" imageAlt="CRU LAB 高質感顯微鏡、研究文獻與實驗室" actionHref="#journal" actionLabel="進入研究筆記"/>
  ...
  <section className="researchVisual"><LuxuryMedia scene="research" alt="高質感顯微鏡、試管、研究文獻與 CRU LAB 產品原型"/><div><span className="eyebrow">研究是一種工作方法</span><h2>研究不是裝飾品牌的語言。<br/>它是產品決策的方法。</h2><p>從原料選擇、配方劑量到溝通內容，每一步都應該知道證據在哪裡，也知道證據的邊界。</p></div></section>
</SiteShell>}
