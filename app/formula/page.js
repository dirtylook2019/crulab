...
export default function FormulaPage(){return <SiteShell>
  <PageHero eyebrow="配方設計" title={<>不是填一張表。<br/>是把產品的理由整理清楚。</>} description="從想改善的問題、偏好的原料、劑型、預算與首批數量開始，建立一個可以繼續研究、估價與製造的配方方向。" image={media.notebook} imageAlt="配方筆記、粉末原料與精密秤" imagePosition="center 52%" actionHref="#builder" actionLabel="開始建立配方"/>
